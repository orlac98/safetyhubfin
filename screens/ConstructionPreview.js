...
import { H1,H3, View, Text, StyleSheet,ScrollView } from "react-native";
...
before the design process begins
      ...
      <View style={styles.topView}>
        <Text style={styles.mainText}>Information on Construction Work</Text>
      ...
      <View style={styles.topView}>
        <Text style={styles.mainText}>Exact Address of Construction Site:</Text>
